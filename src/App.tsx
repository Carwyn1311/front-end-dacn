        ...
        <div className="main-content" style={{ flexGrow: 1, overflow: 'auto' }}>
          ...
          <div style={{ marginTop: '70px' }}>
            ...
            <MyComponent
              title={
                language === 'en'
                  ? 'Discover Australia with Saigontourist'
                  : 'Khám phá Úc cùng Saigontourist'
              }
              content={
                language === 'en'
                  ? 'Join the tour to Melbourne and Sydney to enjoy an unforgettable Tet holiday with unique experiences.'
                  : 'Tham gia tour du lịch đến Melbourne và Sydney để tận hưởng kỳ nghỉ Tết Nguyên Đán không thể quên với những trải nghiệm độc đáo.'
              }
              imageUrl="/img1.jpg"
            />
            <TourDetail
              ...
              details={
                language === 'en'
                  ? [
                      'Celebrate Tet 2025 in the land of kangaroos with a journey through famous cities.',
                      'Visit Melbourne, explore Fitzroy Garden, and meet Australia\'s unique wildlife.',
                      'See the iconic Sydney Harbor with the Opera House and Sydney Bridge.',
                      'Unique experiences with steam trains and cable cars in Jamison Valley.',
                      'Enjoy a gourmet feast on the luxury Sydney Showboat cruise.',
                    ]
                  : [
